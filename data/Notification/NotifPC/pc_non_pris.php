<?php
    ...
    $query = "select personnes.prenoms,machine_etudiants.id_pc as id_pc,inscription.grade,inscription.niveau,presence.date_presence as date,presence.date_presence as presence from machine_etudiants
                ...
                where machine_etudiants.id_pc not in 
                    (select id_pc_etudiant from presence_pc_portable 
                        where presence_pc_portable.statut='Retrait' 
                        and presence_pc_portable.date_operation > '{$yesterday}' 
                        and presence_pc_portable.date_operation < '{$today}')";
