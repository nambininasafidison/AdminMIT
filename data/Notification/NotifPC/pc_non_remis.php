<?php
    ...
    $query = "select personnes.prenoms,t1.id_pc_etudiant as id_pc,inscription.grade,inscription.niveau,t1.date_operation as retrait,presence.date_presence as presence from presence_pc_portable as t1
                left join machine_etudiants on
                    machine_etudiants.id_pc = t1.id_pc_etudiant
                left join inscription on
                    inscription.id_etudiant = machine_etudiants.id_inscription
                ...
                left join presence_pc_portable as t3 on 
                    t3.id_pc_etudiant = t1.id_pc_etudiant 
                    and t3.date_operation>t1.date_operation 
                    and t3.statut = 'Remise' 
                where t1.statut = 'Retrait'
                    and t1.date_operation < '{$today}' 
                    and not exists 
                        (select id_pc_etudiant from presence_pc_portable as t2 
                            where t2.statut = 'Remise' and 
                            t2.id_pc_etudiant = t1.id_pc_etudiant and 
