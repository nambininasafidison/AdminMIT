<?php
    ...
    $query = "select personnes.prenoms, machine_etudiants.id_pc as id_pc, inscription.grade, inscription.niveau from inscription
                ...
                left join machine_etudiants on
                    machine_etudiants.id_inscription = etudiants.id_etudiant
                where machine_etudiants.id_inscription not in 
