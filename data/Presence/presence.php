<?php
    ...
    , stat_pc.date_remise as remise, presence.statut as presence from personnes
                ...
                left join machine_etudiants on
                    machine_etudiants.id_inscription = inscription.id_inscription
                left join stat_pc on machine_etudiants.id_machine = stat_pc.id_pc_etudiant and stat_pc.date_retrait = '{$date}'
    ";
